...
from dataclass_wizard.cli import main, PyCodeGenerator
...
def mock_path(mocker: MockerFixture):
    return mocker.patch('dataclass_wizard.cli.schema.Path')
...
def mock_open(mocker: MockerFixture):
    return mocker.patch('dataclass_wizard.cli.cli.open')
